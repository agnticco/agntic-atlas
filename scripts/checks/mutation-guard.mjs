...
const MUTATIONS = [
  ...
  { file: 'src/converger/elicitation-graph.js',
    ...
    find: '    if (columnsRead && readFields(config)) {\n      config.fields = fields ?? {};',
    repl: '    if (columnsRead && readFields(config) && fields) {\n      config.fields = fields;' },
  { file: 'src/converger/elicitation-graph.js',
  ...
  { file: 'src/converger/elicitation-graph.js',
    name: 'the columns are checked ONCE (the gap loop puts the invented column back, past the latch)',
    find: '    const cached = state.destination;\n    if (cached?.columns) {',
    repl: '    const cached = state.destination;\n    if (false) {' },
  { file: 'src/converger/elicitation-graph.js',
